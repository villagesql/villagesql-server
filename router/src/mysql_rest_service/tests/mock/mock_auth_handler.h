...
class MockAuthHandler : public mrs::interface::AuthorizeHandler {
 public:
  ...
  MOCK_METHOD(bool, authorize,
              (RequestContext & ctxt, const SessionPtr &session,
               AuthUser *out_user),
              (override));
  ...
  MOCK_METHOD(UserManager &, get_user_manager, (), (override));
  MOCK_METHOD(const std::string &, get_handler_name, (), (override, const));
};
