...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_DB_SCHEMA_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_DB_SCHEMA_H_
...
class QueryChangesDbSchema : public QueryEntriesDbSchema {
 ...
 private:
  void query_schema_entries(MySQLSession *session, VectorOfEntries *out,
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_DB_SCHEMA_H_
