...
enum EntitiesCounters {
  ...
  kEntityCounterRestCacheItemLoads,
  kEntityCounterRestCacheItemEjects,
  kEntityCounterRestCacheItemHits,
  kEntityCounterRestCacheItemMisses,
  kEntityCounterRestCachedItems,
  kEntityCounterRestCacheFileLoads,
  kEntityCounterRestCacheFileEjects,
  kEntityCounterRestCacheFileHits,
  kEntityCounterRestCacheFileMisses,
  kEntityCounterRestCachedFiles,
  kEntityCounterRestCachedEndpoints,
