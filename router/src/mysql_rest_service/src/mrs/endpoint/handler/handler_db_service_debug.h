...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_SERVICE_DEBUG_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_SERVICE_DEBUG_H_
...
class HandlerDbServiceDebug : public mrs::rest::Handler {
 public:
 ...
 public:
  HandlerDbServiceDebug(std::weak_ptr<DbServiceEndpoint> endpoint,
