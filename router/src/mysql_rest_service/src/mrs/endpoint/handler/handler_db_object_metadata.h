...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_METADATA_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_METADATA_H_
...
class HandlerDbObjectMetadata : public mrs::rest::Handler {
 public:
 ...
 public:
  HandlerDbObjectMetadata(std::weak_ptr<DbObjectEndpoint> endpoint,
 ...
 public:
  ...
  std::string url_obj_;
  std::string url_obj_metadata_;
  std::string url_sch_metadata_;
};
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_METADATA_H_
