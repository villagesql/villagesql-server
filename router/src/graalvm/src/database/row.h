...
#ifndef ROUTER_SRC_GRAALVM_SRC_DATABASE_ROW_H_
#define ROUTER_SRC_GRAALVM_SRC_DATABASE_ROW_H_
...
class Result;
class Row : public graalvm::db::IRow {
 public:
...
#endif  // ROUTER_SRC_GRAALVM_SRC_DATABASE_ROW_H_
