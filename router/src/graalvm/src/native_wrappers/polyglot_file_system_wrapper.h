...
#ifndef MYSQLSHDK_SCRIPTING_POLYGLOT_NATIVE_WRAPPERS_POLYGLOT_FILE_SYSTEM_WRAPPER_H_
#define MYSQLSHDK_SCRIPTING_POLYGLOT_NATIVE_WRAPPERS_POLYGLOT_FILE_SYSTEM_WRAPPER_H_
...
class Polyglot_file_system_wrapper
    : public Polyglot_native_wrapper<IFile_system, Collectable_type::OBJECT> {
 public:
  Polyglot_file_system_wrapper() = delete;

  explicit Polyglot_file_system_wrapper(
      std::weak_ptr<Polyglot_language> language);

  Polyglot_file_system_wrapper(const Polyglot_file_system_wrapper &) = delete;
  Polyglot_file_system_wrapper &operator=(
      const Polyglot_file_system_wrapper &) = delete;

  Polyglot_file_system_wrapper(Polyglot_file_system_wrapper &&) = delete;
  Polyglot_file_system_wrapper &operator=(Polyglot_file_system_wrapper &&) =
      delete;
...
#endif  // MYSQLSHDK_SCRIPTING_POLYGLOT_NATIVE_WRAPPERS_POLYGLOT_FILE_SYSTEM_WRAPPER_H_
