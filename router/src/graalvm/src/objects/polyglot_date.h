...
#ifndef ROUTER_SRC_GRAALVM_SRC_OBJECTS_POLYGLOT_DATE_H_
#define ROUTER_SRC_GRAALVM_SRC_OBJECTS_POLYGLOT_DATE_H_
...
#endif  // ROUTER_SRC_GRAALVM_SRC_OBJECTS_POLYGLOT_DATE_H_
