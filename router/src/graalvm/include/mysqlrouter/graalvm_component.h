...
struct Global_config {
  bool operator==(const Global_config &o) const {
  ...
  std::optional<uint64_t> default_pool_size;
};

struct Graalvm_service_handler_config {
...
class IGraalvm_service_handlers {
 public:
  ...
  virtual std::optional<uint64_t> pool_size() const = 0;
