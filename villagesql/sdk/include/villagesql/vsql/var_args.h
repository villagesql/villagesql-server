...
//
// Varargs registration requires VEF_PROTOCOL_3 — older servers do not
...
// the protocol-3 pointer layout (args->values) because varargs registration
// requires VEF_PROTOCOL_3.
class VarArgs {
 public:
